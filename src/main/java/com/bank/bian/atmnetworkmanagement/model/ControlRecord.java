package com.bank.bian.atmnetworkmanagement.model;
...
/**
 * The BIAN control record for this service domain: "ATM Network Operating Session".
 *
 ...
 * to its asset type (ATM Network). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "ATM Network Operating Session";
